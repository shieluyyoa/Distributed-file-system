...
void Usage() {
    std::cout <<
        ...
        "-a, --address <address>:  The rpc server address to connect to (default: 0.0.0.0:49189)\n"
        ...
        "-t, --deadline_timeout <int>:  The deadline timeout in milliseconds (default: 11000)\n"
        "-h, --help:               Show help\n"
        "\n"
...
int main(int argc, char** argv) {
    ...
    std::string server_address = "0.0.0.0:49189";
    std::string command = "";
    std::string filename = "";
    int debug_level = static_cast<int>(LL_ERROR);
    int deadline_timeout = 11000;
